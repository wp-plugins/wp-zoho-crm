=== A CRM Zoho integration for Wordpress to capture Leads and Contacts ===
...
An easy, automated and advanced CRM Zoho web form generator for Wordpress to capture leads. Also integrate/sync Wordpress member registration as Contacts.
...
Version 1.2 is available with debug mode enable and disable options in settings along with menu changes. Users who faced zoho credential issues due to auth token run outs can be solved now, read the faq for details.
...
WP Zoho CRM plugin is an advanced CRM Zoho web forms module download now to enjoy the easy advanced hassle free web form integration with your Wordpress. 
...
== Installation ==
1.    Unzip the file 'wp-zoho-crm.zip'.
2.    Upload the ' wp-zoho-crm ' directory to '/wp-content/plugins/' directory using ftp client or upload and install wp-zoho-crm.zip through plugin install wizard in wp admin panel .
3.    Activate the plugin through the 'Plugins' menu in WordPress.
4.    After activating, you will see an option for 'WP Zoho CRM' in the admin menu (left navigation) and you will import the csv files to import the data's.

 
== Screenshots ==

1. The screenshot-1.png shows the Zoho CRM settings configuration
2. The screenshot-2.png shows the CRM Zoho lead fields to be shown in the contact form page or post.
3. The screenshot-3.png shows the CRM Zoho lead fields to be shown in the widget area.
4. The screenshot-4.png shows the form which captures the Zoho CRM leads.
5. The screenshot-5.png shows the form placed in widget area, which captures the Zoho CRM leads.
...
Why my credentials are not working / saved?

This is because auth tokens cannot be created any more for your zoho account. Follow the steps below
1. Login to https://accounts.Zoho.com 
2. Delete some tokens and free up to add new tokens. 
Now the issue will be solved.

How To Install WP Zoho CRM Free plugin in wordpress ?
